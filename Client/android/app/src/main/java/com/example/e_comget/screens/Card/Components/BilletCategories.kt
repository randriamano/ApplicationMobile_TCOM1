...
@Composable
fun BilletScreen(navControllerApp: NavHostController){
    Column{
        Box(
            modifier = Modifier
                .fillMaxWidth()
            ...
            Box{
                Image(painter = painterResource(R.drawable.billet),
        ...
        LazyVerticalGrid(
            ...
            items(command.size) {
                    index -> CommandBilletList(index = index, navControllerApp)
            }
        }
    }
}
...
@Composable
fun CommandBilletList(index : Int,navControllerApp: NavController) {
