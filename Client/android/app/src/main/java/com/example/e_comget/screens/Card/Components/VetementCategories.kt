...
@Composable
fun VetementScreen(navController: NavHostController){
    ...
    Column{
        Box(
            ...
            Box{
                Image(painter = painterResource(R.drawable.vetements),
        ...
        LazyVerticalGrid(
            ...
            items(command.size) {
                    index -> CommandList(index = index, navController)
            }
        }
    }
}
...
@Composable
fun CommandList(index : Int,navController: NavController) {
